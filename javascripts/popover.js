/**
 * Source: https://github.com/nahojd/vanilla-tooltip/blob/master/tip.js
 */
 'use strict';
 ...
 (function() {
 	function Tip() {
      ...
      // changed '...popover.clientHeight - 5)' to move box up, away from text
      popover.style.top = (targetRect.top + scrollY - popover.clientHeight - 10) + 'px';
			popover.className = popover.className + ' popover-clone';
